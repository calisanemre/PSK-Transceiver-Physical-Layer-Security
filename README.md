# QPSK Transceiver with Physical Layer Security (Artificial Noise)

This repository contains a full QPSK transceiver chain implemented in MATLAB, focusing on synchronization and **Physical Layer Security (PLS)**. It demonstrates how artificial noise can protect data from unauthorized eavesdroppers.
...
- The system integration, security layer (AN/XOR), and QPSK object-oriented logic were developed by me as part of my academic work.
...
- Sistem entegrasyonu, güvenlik katmanının kurgulanması (AN ve XOR mekanizmaları) ve QPSK nesne yönelimli mantığı akademik çalışmalarım kapsamında tarafımdan geliştirilmiştir.
